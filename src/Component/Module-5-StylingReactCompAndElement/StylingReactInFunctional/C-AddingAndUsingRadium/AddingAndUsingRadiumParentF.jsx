...
import AddingAndUsingRadiumChildF from "./AddingAndUsingRadiumChildF";
import Radium, { StyleRoot } from "radium";

const AddingAndUsingRadiumParentF = () => {
  const defaultPerson = [
  ...
  return (
    <StyleRoot>
      <div className="mt-2">
        <p className={classes.join(" ")}>3.Adding & Usng Radium </p>
...
export default Radium(AddingAndUsingRadiumParentF);
