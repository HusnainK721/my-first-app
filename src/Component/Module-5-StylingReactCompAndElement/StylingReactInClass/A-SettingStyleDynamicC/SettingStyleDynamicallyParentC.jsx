...
import SettingStyleDynamicallyChildC from "./SettingStyleDynamicallyChildC";

export class SettingStyleDynamicallyParentC extends Component {
  state = {
    person: [
      { name: "Batman", age: 25 },
